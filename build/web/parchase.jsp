...
<html lang="en">
    ...
    <body>
        ...
        <main>
            <div class="formb">
                <form action="includes/parchase_contr.jsp" method="POST" class="form" onsubmit="return validateTotalBill()">
...
<!--                        <div class="input-group">
        ...
        <script>
                    ...
                    function getEventId() {
                        ...
                        xhr.open('GET', `includes/event_contr.jsp?event=${event}&category=${category}`, true);
                        xhr.send();
                    }
                    ...
                    function updateTotalBill(eventId) {
                        ...
                        xhr.open('GET', `includes/get_event_price.jsp?eventId=${eventId}`, true);
                        xhr.send();
                    }
